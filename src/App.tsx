              ...
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xs flex flex-col gap-5">
                ...
                {items.length > 0 && (
                  <div className="border-t border-slate-100 dark:border-slate-800 pt-4 mt-2">
                    <label className="text-[10px] uppercase font-black tracking-wider text-slate-400 block mb-2">
                      Save / Export Updated Checklist
                    </label>
                    <p className="text-[11px] text-slate-400 mb-3 leading-relaxed">
                      Save newly inserted/updated audit-points directly back to a local XML file for future uploads.
                    </p>
                    <div className="flex flex-col gap-2">
                      <button
                        ...
                        title="Download updated checklist tasks as a local XML file"
                      >
                        <Download className="w-4 h-4" />
                        <span>Save & Export XML File</span>
                      </button>
                    </div>
                  </div>
                )}
